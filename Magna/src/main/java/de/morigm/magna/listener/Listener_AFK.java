...
public class Listener_AFK extends ListenerHelper {
	...
	public void testIfNotAFK(PlayerMoveEvent e) {
		if (getAFKManager().isAfk(e.getPlayer())
				&& (getAFKManager().getLocation(e.getPlayer()).getBlockX() != e.getPlayer().getLocation().getBlockX()
						|| getAFKManager().getLocation(e.getPlayer()).getBlockY() != e.getPlayer().getLocation()
								.getBlockY()
						|| getAFKManager().getLocation(e.getPlayer()).getBlockZ() != e.getPlayer().getLocation()
								.getBlockZ())) {
